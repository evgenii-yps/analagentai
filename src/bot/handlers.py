...
REFUSAL_RU: dict[str, str] = {
    ...
    # Версия 7 §4: единственный ограничитель ЧАСТОТЫ сделок. Прежние
    # «по инструменту уже есть позиция» и «все слоты заняты» удалены вместе с
    # самими правилами — перевод причины, которой больше не бывает, однажды
    # появился бы в сводке и читался бы как действующее ограничение.
