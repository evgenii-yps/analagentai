...
class Settings(BaseSettings):
    ...
    # Лента сделок: трое суток сырья. Содержательная часть не теряется — перед
    ...
    # удаляются никогда. Решение принято по §4.3 отчёта 8.1: при пяти токенах
    # сырая лента упирается в потолок коллектора и не помещается на диск.
    RETENTION_TRADES_DAYS: int = 3
